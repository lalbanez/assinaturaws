...
//			validateSign(doc, fac);
    ...
    static void getProp() throws IOException {
		...
		FileInputStream file = new FileInputStream("C:\\Users\\Leandro Albanez\\Documents\\TASKS\\Esocial\\AssinaturaWS\\dados.properties");
		props.load(file);
		certAlias = props.getProperty("prop.cert.alias");
		certPassword = props.getProperty("prop.cert.password");
	}
}
